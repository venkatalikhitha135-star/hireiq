...
export default function HRLogin() {
  ...
  // Demo credentials
  const DEMO_EMAIL = 'hr@company.com'
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-slate-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl border border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-8 py-3 px-4 rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 text-white font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-8 pt-8 border-t border-slate-200">
            ...
            <div className="space-y-2 text-xs text-slate-600">
              <div className="flex justify-between items-center p-2 bg-slate-50 rounded-lg">
                <span>Email:</span>
                <code className="font-mono font-semibold text-slate-900">{DEMO_EMAIL}</code>
              </div>
              <div className="flex justify-between items-center p-2 bg-slate-50 rounded-lg">
                <span>Password:</span>
